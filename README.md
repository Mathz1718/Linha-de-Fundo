...
4. Escreva uma breve descrição do que mudou e clique em **“Create pull request”**
...
> ⚠️ **Dica:** sempre use nomes de branches curtos e descritivos.  
> Exemplo: `feature/aba-noticias`, `fix/footer`, `ajustes-css`.

---

💡 **Autor:** [Matheus Morais](https://github.com/Mathz1718)  
📅 **Fluxo Git mantido por:** Equipe Linha de Fundo
